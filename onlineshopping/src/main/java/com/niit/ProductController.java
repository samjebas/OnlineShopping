...
public class ProductController 
{
	...
	public String crudPage(Model m) {
	...
	public String addProduct(@ModelAttribute("product") Product product,@RequestParam("pimage") MultipartFile productImage,Model m)
	{
		...
		String path="D:\\eclipse-workspace\\onlineshopping\\src\\main\\webapp\\resources\\images\\";
...
public String updateProduct(@PathVariable("productId") int productId,@RequestParam("price") int price)
{
